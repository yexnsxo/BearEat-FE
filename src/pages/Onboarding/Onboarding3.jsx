    ...
    <div className="flex items-center justify-center">
      <div className="w-[390px] bg-white">
        ...
        <div className="flex flex-col relative">
          <div className="flex flex-col gap-4 ml-[52px] mt-10">
          ...
          <div className="absolute -bottom-[25px] right-12 text-gray-300 text-[13px] font-[SemiBold]">
            중복 선택 불가
          </div>
        </div>
        <div className="mt-[68px] px-6 flex justify-end">
